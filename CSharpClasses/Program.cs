    ...
    public class Bug
{
    ...
    */
    ...
    class Program
    {
        ...
        {
            var grasshopper = new Bug("Hopper", "green", new List<string> { "bird", "snake", "human" }, new List<string> { "ant", "mite" });
            Console.WriteLine(grasshopper.FormalName);
            Console.WriteLine(grasshopper.PreyList());
            Console.WriteLine(grasshopper.PredatorList());
